...
if($tw.browser && !window.CodeMirror) {
	...
	window.CodeMirror.commands.save = function(cm) {
		$tw.cm = cm;
		if (cm.widget && cm.widget.editTitle) {
			cm.widget.dispatchEvent({type: 'tm-save-tiddler', tiddlerTitle: cm.widget.editTitle})
		}
	}
